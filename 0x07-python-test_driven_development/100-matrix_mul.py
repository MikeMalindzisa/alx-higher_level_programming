...
def matrix_mul(m_a, m_b):
    ...
    Raises: TypeError: If m_a or m_b is not a list of lists, if they contain 
    non-integer/float elements, or if they are not rectangular. ValueError: 
    If m_a or m_b is empty or if they can't be multiplied.
    """
