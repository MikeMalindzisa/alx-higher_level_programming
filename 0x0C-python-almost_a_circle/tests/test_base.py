...
class TestBase(unittest.TestCase):
    ...
    def setUp(self):
        """Redirect stdout to a readable buffer to check the output of
        methods relying on the print function."""
        sys.stdout = StringIO()

    def tearDown(self):
        """Reassign true stdout file stream to sys.stdout following test completion.
        Printing goes to the screen as before."""
